...
- story 页面隐藏顶部站点导航栏，保留博客和笔记页面的导航。
...
进入 story 后，页面像一张纯白背景上的摄影画册：顶部没有站点导航，标题区紧凑，相框边界清晰但不厚重，底部只保留一个易识别的返回箭头。打开照片后，左右切换足够轻、不遮挡照片，右上角不出现关闭按钮，同时仍可通过背景、Esc 或垂直拖动退出。
